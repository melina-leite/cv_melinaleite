...
<!--- Ideia do Dynamic Ecology 23.03.2025L expand the status of the manuscript in prep
- Draft manuscript, in reveiw with co-authors
- results completed, manuscript partially drafted
--->
...
2.  **Leite, M. de S.**, De Deurwaerder, H., Hülsmann, L., & Visser, M. D. Are There Limits to the Predictability of Forest Dynamics? *To Be Submitted to Biogeosciences.* Manuscript partially drafted.

3.  Morato, K., **Leite, M. de S.**, ..., Metzger, J. P. Unpacking the Effects of Urban Green Areas Exposure on Mental Health: A Meta‐Analysis. *Submitted to Urban Ecosystems.*
